...
class AccountEdiDocument(models.Model):
    ...
    l10n_ec_partner_vat = fields.Char(
        related="l10n_ec_partner_id.vat", string="Ced/RUC", readonly=True
    )
    l10n_ec_partner_email = fields.Char(
        related="l10n_ec_partner_id.email", string="Customer Email", readonly=True
    )
