...
from cryptography.hazmat.primitives.serialization import (
    ...
    pkcs12,  # pylint: disable=W7936
)
from cryptography.x509 import (  # pylint: disable=W7936
    ExtensionNotFound,
...
class SriKeyType(models.Model):
    ...
    p_key = fields.Binary(
        "Private Key", readonly=True, attachment=False, required=True, default="p_key"
    )
    cert = fields.Binary(
        "X509 Certificate",
        readonly=True,
    ...
    def action_sign(self, xml_string_data):
        ...
        #  Quitar comentario para medir la velocidad de la firma
        # current_time = datetime.datetime.utcnow().microsecond

        private_key = load_pem_private_key(
            b64decode(self.p_key), password=self.password.encode()
        )
