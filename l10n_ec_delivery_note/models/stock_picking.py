...
class StockPicking(models.Model):
    ...
    def button_validate(self):
        ...
        for pick in self.filtered("l10n_ec_create_delivery_note"):
            ...
            if self._check_backorder() and not ctx.get("skip_backorder", False):
                return self.with_context(**ctx)._action_generate_backorder_wizard()
                    ...
                    .create(
                        {
                            ...
                            and pick.partner_id.commercial_partner_id.id
                            or None,
                            "l10n_ec_journal_id": pick.l10n_ec_delivery_note_journal_id
                            and pick.l10n_ec_delivery_note_journal_id.id
                            or None,
    ...
    def action_cancel(self):
        for pick in self:
            if pick.l10n_ec_delivery_note_ids:
                pick.l10n_ec_delivery_note_ids.action_cancel()
